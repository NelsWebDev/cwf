...
export type ClientEmittedEventFunctions = {
  [K in keyof ClientEmittedEvents]: ClientEmittedEvents[K] extends void
    ? () => void
    : (arg: ClientEmittedEvents[K]) => void;
};

export type ServerEmittedEventFunctions = {
  [K in keyof ServerEmittedEvents]: ServerEmittedEvents[K] extends void
    ? () => void
    : (arg: ServerEmittedEvents[K]) => void;
};
